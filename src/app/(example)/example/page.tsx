        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600">Multiple authentication methods including secret keys and Discord OAuth.</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Nostr Integration</h3>
              <p className="text-gray-600">Real-time connection to Nostr relays for community events and interactions.</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              ...
              <p className="text-gray-600">Designed for onboarding members to Nostr communities with ease.</p>
            </div>
          </div>
        </div>
      </div>
