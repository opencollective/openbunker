...
export default function UserProfileEvent() {
  const { userProfile, bunkerStatus, updateUserProfile, fetchUserProfile } = useNostr();
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      {!userProfile && !isEditing ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Lightning Address (LUD06)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Lightning Address (LUD16)</label>
              <input
                type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">NIP-05 Identifier</label>
            <input
              type="text"
            ...
            <>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">
                    {parseProfileData(userProfile).display_name || parseProfileData(userProfile).name || 'Anonymous'}
                  </h3>
              ...
              {parseProfileData(userProfile).about && (
                <div>
                  ...
                  <p className="text-sm text-gray-600">{parseProfileData(userProfile).about}</p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                {parseProfileData(userProfile).nip05 && (
                  <div>
                    ...
                    <span className="ml-2 text-gray-600">{parseProfileData(userProfile).nip05}</span>
                  </div>
                )}
              </div>
              ...
              <div className="text-xs text-gray-500 pt-2 border-t">
                ...
                <p>Created: {new Date(userProfile.created_at * 1000).toLocaleString()}</p>
              </div>
            </>
          )}
        </div>
