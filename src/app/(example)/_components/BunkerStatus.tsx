...
export default function BunkerStatus() {
  const { bunkerStatus, bunkerError, bunkerConnectionToken, bunkerSigner } = useNostr();
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">
              ...
              {bunkerStatus === 'connecting' && 'Establishing secure connection...'}
        ...
        {bunkerConnectionToken && (
          <div className="p-3 bg-blue-50 rounded-lg">
            <p className="text-xs font-medium text-blue-900 mb-1">Connection Token</p>
            <p className="text-xs text-blue-700 font-mono break-all">
              {bunkerConnectionToken.slice(0, 20)}...{bunkerConnectionToken.slice(-20)}
            </p>
          </div>
        )}
        ...
        {bunkerSigner && bunkerStatus === 'connected' && (
          <div className="p-3 bg-green-50 rounded-lg">
            <p className="text-xs font-medium text-green-900 mb-1">Bunker Signer</p>
            <p className="text-xs text-green-700">Active and ready for signing operations</p>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          <div>
            ...
            <p className="font-medium text-gray-900 capitalize">{bunkerStatus}</p>
          </div>
          <div>
